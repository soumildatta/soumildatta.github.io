...
My research interests include parallel programming and machine learning applications. My current research is focused on developing a concurrent priority queue for GPU architectures, as well as analyzing the advantages of Genetic Algorithms on tasks such as image reconstruction and improving local surrogate model stabilities. In the past, I have worked with my mentor to design a scheduler that allows the scheduling of generational dependencies on concurrent GPU environments. I have also worked with my mentor to create a a parallel SSSP algorithm for the CPU which performs better than Bellman-ford while retaining its parallelizable characteristics. Besides genetic algorithms, concurrent algorithms, and data structure research, I also have research experience with Machine Learning, VR, and AR technologies.
