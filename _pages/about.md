...
I am a Ph.D. student @ Kahlert School of Computing, University of Utah. I work with [Dr. Guanhong Tao](https://tao.aisec.world) at the SaLT Lab, broadly focusing on ML/AI security and robustness. I am currently exploring the various vulnerabilities and unexpected behaviors of generative media AI systems such as T2I difusion models. My primary motivation is to uncover vulnerabilities and aid in the development of models that are not only robust, secure, and transparent, but also efficiently designed. 
...
Previously, I was part of the [Heterogeneous Research Lab (HEROES)](https://john.cs.olemiss.edu/heroes/), developing a novel concurrent priority queue, an improved concurrent SSSP algorithm, and a GPU scheduler for generational dependencies. I was also part of the [High Fidelity Virtual Environments Lab](http://www.hi5lab.org/doku.php?id=main:members), where I created a VR environment to study optical illusions in 3D space and tested AR tracking accuracy via video conferencing software.
